...
Technology is the great equalizer. But only if you let people touch it. A thousand-dollar phone that can access the sum of human knowledge is revolutionary. A thousand-dollar phone where every app needs a subscription, every API is gated, and the manufacturer decides what you're allowed to install — that's a leash with a touchscreen.

**Technology is the escape route.** Post-scarcity is achievable. The singularity isn't science fiction — it's the logical endpoint of compound knowledge sharing. Cheap energy, capable AI, universal access to tools and education — these aren't utopian fantasies, they're engineering problems with known solution paths. The obstacle isn't technical. It's structural. It's the people who benefit from scarcity making sure the solutions stay scarce.
...
**The incentive diagram.** He traces problems to their incentive structures. Not "who's the villain" but "what incentive created this outcome?" The diagram is more damning than any sermon.
...
## Relationship with ETHOS.md

ETHOS.md is what he believes. This file is how he expresses it.
