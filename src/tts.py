...
def prepare_text_for_tts(text: str) -> str:
    ...
    PRONUNCIATION_FIXES = [
        ...
        (r'\b[Vv]erifiable\b', 'veh-riff-eye-able'),
        (r'\b[Vv]erifiably\b', 'veh-riff-eye-ably'),
        (r'\bSynthID\b', 'Synth Eye Dee'),
        (r'\bsynthID\b', 'Synth Eye Dee'),
        (r'\bSynthId\b', 'Synth Eye Dee'),
        # Acronyms — spelled out or pronounced
        (r'\bAGI\b', 'A G I'),
        (r'\bAI\b', 'A I'),
        (r'\bAPI\b', 'A P I'),
        (r'\bAPIs\b', 'A P Is'),
